    ...
    <div className="home">
      ...
      <div className="hero-section hero-section-2" style={{ backgroundImage: `url(${heroimg2})` }}>
        <div className="hero2-textblock">
          <p className="hero2-quote">“I have never felt so seen and appreciated by anyone. I was put on the highest of all pedestals and lived in a dream, but a short-lived one.</p>
          <p className="hero2-quote">From lots of declarations of love, flowers and chocolates, it quickly changed to constant insults, devaluation and gaslighting. The latter is the technique that makes us question our own reality and identity.</p>
          ...
          <p className="hero2-quote">Do you recognize yourself in any of this? Then you have probably been the victim of a toxic or narcissistic relationship. Do you need advice and support to take back your life and your dignity?</p>
          <p className="hero2-quote"><b>Welcome to Good As You Are</b></p>
        </div>
      </div>
    </div>
  );
